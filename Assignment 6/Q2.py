...
if __name__ == "__main__":
    fig, (pendulum_ax, err_ax) = plt.subplots(2, 1, figsize=(14, 8))
    err_ax.set_title("Energy deviation")
    pendulum_ax.add_patch(plt.Circle((0, 0), 2.0, color='lightgray', fill=False))
    ...
    state1 = np.array([np.pi/3, -np.pi/3.0, 0.0, 0.0]) # theta1, theta2, p1, p2

    st, show = create_animatable_pendulum(dt, t, pendulum_ax, err_ax, state1, "lightgreen")
